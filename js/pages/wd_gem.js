...
const wdGemItems = [
  ...
  {
    id: 'wd_non_back_5_gem',
    ver: ['rr'],
    image: './images/item/gem/wd_non_back_5_gem.jpeg',
    buyLink: 'https://weidian.com/item.html?itemID=6739361140',
    title: '【宝石】普版',
    brand: ['K4', 'KMS', 'AM', 'EL', 'SR'],
    hit: ['全指定李龙馥'],
    descLink: 'https://weibo.com/5947554719/NoH1np2dw',
    price: '¥ 350',
    shipping: 'non-back',
    onlyFelix: true,
    allVersion: true,
  ...
  {
    id: 'wd_non_back_k4_gem',
    ver: ['rr'],
    image: './images/item/gem/wd_non_back_k4_gem.jpeg',
    buyLink: 'https://weidian.com/item.html?itemID=6738448545',
    title: '【宝石】K4普版',
    brand: ['K4'],
    hit: ['可指定成员'],
    descLink: '',
